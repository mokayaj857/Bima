...
export default function LandingPage() {
  ...
  const handleShareContent = () => {
    // Redirect to dashboard directly when button is pressed
    ...
    <div className="landing-page">
      ...
      <header className="header">
        <div className="header-left">
          <div className="logo">
            <span className="logo-text">BIMA</span>
          </div>
        </div>
          ...
          <div className="text-section">
            ...
            <div className="headline-container">
              <h1 className="main-headline">
                ...
                <span className="rhoda-text">BIMA</span>
          </h1>
            </div>

            <p className="description">
              A smart water management system powered by IoT that uses a network of sensors, controllers, and data platforms to monitor, analyze, and optimize water usage, quality, and infrastructure, offering much-needed advances for resource-scarce regions like Africa.
            </p>

            <div className="cta-container">
              <button onClick={handleShareContent} className="cta-button">
                <div className="cta-inner">
                  <span className="cta-text">Take me to Dashboard</span>
                </div>
          </button>
            </div>
          </div>
